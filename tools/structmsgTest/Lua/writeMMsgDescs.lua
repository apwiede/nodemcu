...
function writeMAVals()
  ...
  checkOK(result,"write")    
  result=structmsg2.writeLine(handleMA,"ModConn,@getModulConnection\n")
  checkOK(result,"write")    
  ...
  checkOK(result,"write")    
  result=structmsg2.writeLine(handleMA,"numSsid,@getNumSSIDs\n")
  checkOK(result,"write")    
  result=structmsg2.writeLine(handleMA,"Reserve,@getReserve1\n")
  checkOK(result,"write")    
  result=structmsg2.closeFile(handleMA)
  checkOK(result,"close") 
end
