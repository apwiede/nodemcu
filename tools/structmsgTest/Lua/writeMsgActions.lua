...
function writeMsgActions()
  ...
  checkOK(result,"open")  
  result=structmsg2.writeLine(handleMA, "#,22\n")
  ...
  checkOK(result,"write")    
  result=structmsg2.writeLine(handleMA, "getIPAddr,2,uint8_t,M\n")
  checkOK(result,"write")    
  result=structmsg2.writeLine(handleMA, "getFirmwareVersion,2,uint8_t,M\n")
  checkOK(result,"write")    
  ...
  checkOK(result,"write")    
  result=structmsg2.writeLine(handleMA, "getDeviceSecurity,2,uint8_t,M\n")
  checkOK(result,"write")    
  ...
  checkOK(result,"write")    
  result=structmsg2.writeLine(handleMA, "getReserve1,2,uint8_t,M\n")
  checkOK(result,"write")    
  result=structmsg2.writeLine(handleMA, "getReserve2,2,uint8_t,M\n")
  checkOK(result,"write")    
  result=structmsg2.writeLine(handleMA, "getReserve3,2,uint8_t,M\n")
  checkOK(result,"write")    
